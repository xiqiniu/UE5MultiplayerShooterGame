...
void UBlasterAnimInstance::NativeUpdateAnimation(float DeltaTime)
{
	...
	// 测试AimRotation和MovementRotation
	//if (!BlasterCharacter->HasAuthority() && !BlasterCharacter->IsLocallyControlled())
	//{
	//	UE_LOG(LogTemp, Warning, TEXT("AimRotation Yaw %f: "), AimRotation.Yaw);
	//	UE_LOG(LogTemp, Warning, TEXT("AimRotation Yaw %f: "), MovementRotation.Yaw);
	//}
	...
	if (bWeaponEquipped && EquippedWeapon && EquippedWeapon->GetWeaponMesh() && BlasterCharacter->GetMesh())
	{
		...
		if (BlasterCharacter->IsLocallyControlled())
		{
			...
			FTransform RightHandTransform = EquippedWeapon->GetWeaponMesh()
		...
		// 说明枪口位置与实际发射位置的区别
		//FTransform MuzzleTipTransform = EquippedWeapon->GetWeaponMesh()
